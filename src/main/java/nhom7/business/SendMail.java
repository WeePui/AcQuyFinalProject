...
public class SendEmail {
    ...
    public boolean sendEmail(Customer customer, String email, String name, String phone, String address, String total, String rootlink) {
        boolean test = false;

        String toEmail = customer.getEmail();
        String fromEmail = "acquyfinalproject@gmail.com";
